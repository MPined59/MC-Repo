 ...
 * Description: Arena class that implements Building interface
 * Due: 12/11/2025
...
public class Arena implements Building {
	...
	public String toString() {
		return String.format("Arena[color=%s, length=%.2f, width=%.2f, buildingType=%s]", getColor(), getLength(),
				getWidth(), getBuildingType());
	}
